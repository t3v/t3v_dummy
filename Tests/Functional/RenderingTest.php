<?php
namespace T3v\T3vDummy\Tests\Functional;
 ...
 *
 * @package T3v\T3vDummy\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Dummy</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_dummy/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
